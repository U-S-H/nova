...
<head>
    ...
    <style>
        ...
        .node-img { width: 100%; height: 140px; object-fit: cover; }
    </style>
</head>
<body>
        ...
        <div id="dash-screen" class="screen active-screen px-4 pt-4">
            <div class="flex justify-between items-center mb-6 px-1">
                ...
                <div class="bg-green-50 px-3 py-1.5 rounded-full border border-green-100 flex items-center gap-2">
                    ...
                    <span class="text-[8px] font-black text-green-600 uppercase">ACTIVE-NODE</span>
                </div>
            </div>
            ...
            <div class="nova-card p-6 mb-6 space-y-6">
                <div>
                    ...
                    <div class="flex gap-2">
                        ...
                        <button onclick="copyRef()" class="btn-gold px-5 rounded-xl">Copy</button>
                    </div>
                </div>
            </div>
    ...
    <script type="module">
        ...
        function loadNodes() {
            ...
            const plans = [{p:20, d:1.6, n:"Nova S19"}, {p:100, d:8.5, n:"Nova M30"}];
            plans.forEach(plan => {
                c.innerHTML += `<div class="nova-card p-4 flex justify-between items-center">
                    <div><h3 class="font-bold text-xs">${plan.n}</h3><p class="text-green-500 text-[10px]">+$${plan.d}/day</p></div>
                    <button onclick="buyNode(${plan.p},${plan.d})" class="btn-gold px-4 py-2">$${plan.p}</button>
                </div>`;
            });
        }
        ...
        function runTimer() {
            setInterval(() => {
                ...
                document.getElementById('yield-timer').innerText = `${h}:${m}:${s}`;
            }, 1000);
        }
