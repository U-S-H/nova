...
<body>
    ...
    <script type="module">
        ...
        const nodes = [
            { id: 1, name: "Nano Core", cost: 20, yield: 1.5 },
            { id: 2, name: "Bronze Rig", cost: 100, yield: 8.5 },
            { id: 3, name: "Silver Hub", cost: 500, yield: 45.0 },
            { id: 4, name: "Gold Blade", cost: 2000, yield: 210.0 },
            { id: 5, name: "Titan Master", cost: 5000, yield: 580.0 },
            { id: 6, name: "Empire Cluster", cost: 10000, yield: 1250.0 },
            { id: 7, name: "Quantum Nexus", cost: 25000, yield: 3400.0 }
        ];
